                ...
                <div className="flex flex-col md:flex-row items-start md:items-center bg-white shadow-md rounded-lg p-6 gap-12">
                    ...
                    <div className='md:w-1/2 flex flex-col'>
                        ...
                        <div className="flex items-center mb-4">
                            ...
                            {deproduct.attributes.colors.length > 0 && deproduct.attributes.colors.map((colorProduct, index) => (
                        ...
                        <button 
                            ...
                            onClick={handleAddToBag} // Tugmani bosganda `handleAddToBag` funksiyasini chaqirish
                        >
                            ADD TO BAG
                        </button>
                    </div>
